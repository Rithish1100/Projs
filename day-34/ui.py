...
class Quizui():
    def __init__(self,quiz_brain:QuizBrain):
        ...
        self.right_button=Button(image=right_image,highlightthickness=0,command=self.true_click)
        self.right_button.grid(row=2,column=0)

        wrong_image=PhotoImage(file="images/false.png")
        self.wrong_button=Button(image=wrong_image,highlightthickness=0,command=self.false_click)
